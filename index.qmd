...
My current project is utilizing multivariate data sets such as the [*Cross-National Time Series*](https://www.cntsdata.com/), [*Varieties of Democracy*](https://v-dem.net/), and others to more effectively operationalize political instability in empirical studies of civil war. I'm also working on my first dataset: the [*Compiled Democracy Index*](CDI.qmd).
